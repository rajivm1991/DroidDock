...
- Use `opencode run -m github-copilot/claude-3.5-haiku` with file content
- Example: `cat README.md | opencode run -m github-copilot/claude-3.5-haiku "Give me a summary of what this project is about"`
